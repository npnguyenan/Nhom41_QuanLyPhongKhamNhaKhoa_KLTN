...
INSERT IGNORE INTO caidat_website (ten_key, ten_value, mo_ta, loai, nhom, thu_tu) VALUES
('banner_title', '', 'Tiêu đề banner trang chủ', 'text', 'feature', 10),
...
INSERT IGNORE INTO caidat_website (ten_key, ten_value, mo_ta, loai, nhom, thu_tu) VALUES
('site_address', '67 Minh Khai, T&A, Lạng Sơn', 'Địa chỉ của phòng khám', 'text', 'contact', 10),
('site_phone', '0253 836 836', 'Số điện thoại liên hệ', 'text', 'contact', 20),
('site_email', 'phongkhamT&A@gmail.com', 'Email liên hệ', 'text', 'contact', 30),
...
INSERT IGNORE INTO caidat_website (ten_key, ten_value, mo_ta, loai, nhom, thu_tu) VALUES
('site_facebook', 'https://facebook.com/phongkhamT&A', 'Link Facebook', 'text', 'social', 10),
('site_twitter', 'https://twitter.com/phongkhamT&A', 'Link Twitter', 'text', 'social', 20),
('site_instagram', 'https://instagram.com/phongkhamT&A', 'Link Instagram', 'text', 'social', 30),
('site_youtube', 'https://youtube.com/phongkhamT&A', 'Link YouTube', 'text', 'social', 40);

-- Thêm hoặc cập nhật cài đặt chung
INSERT IGNORE INTO caidat_website (ten_key, ten_value, mo_ta, loai, nhom, thu_tu) VALUES
('site_name', 'Nha Khoa T&A', 'Tên trang web', 'text', 'general', 10),
...
('site_keywords', 'phòng khám, đặt lịch khám, bác sĩ, chuyên khoa, dịch vụ y tế, T&A, lạng sơn', 'Từ khóa SEO', 'text', 'general', 30),
...
('site_support_email', 'support@T&A.com', 'Email hỗ trợ', 'text', 'contact', 35),
('site_advise_email', 'tuvan@T&A.com', 'Email tư vấn', 'text', 'contact', 36),
