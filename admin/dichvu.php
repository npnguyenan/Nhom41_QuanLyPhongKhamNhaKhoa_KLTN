...
<head>
    ...
    <title>Quản lý Dịch vụ - Nha Khoa T&A</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addServiceForm" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="giaCoBan" class="form-label">Giá kham khảo <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editServiceForm" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="edit_giaCoBan" class="form-label">Giá kham khảo <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
