...
?>
<?php if (in_array($_SESSION['vai_tro'], ['admin', 'nhanvien'])): ?>
<div class="sidebar">
    <div class="sidebar-content d-flex flex-column p-3 text-white">
        ...
        <a href="tongquan.php"
            ...
            <span class="fs-6"><?php echo get_setting('site_name', 'T&A Clinic'); ?></span>
        </a>
        <hr>
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                ...
                <img src="https://i.etsystatic.com/45893541/r/il/545bc4/6453954482/il_570xN.6453954482_q062.jpg" alt="" width="32" height="32" class="rounded-circle me-2">
...
<div class="mobile-header">
    ...
    <span class="brand-text"><?php echo get_setting('site_name', 'T&A Clinic'); ?></span>
    <div class="dropdown">
        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
            id="mobileUserDropdown" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="https://i.etsystatic.com/45893541/r/il/545bc4/6453954482/il_570xN.6453954482_q062.jpg" alt="" width="32" height="32" class="rounded-circle">
        </a>
