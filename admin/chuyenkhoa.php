...
<head>
    ...
    <title>Quản lý Chuyên khoa - Nha Khoa T&A</title>
    <!-- Bootstrap CSS -->
                                        ...
                                        <div class="specialty-card">
                                            <div class="specialty-image">
                                                <?php if (!empty($specialty['hinh_anh'])): ?>
                                                    <img src="../<?php echo htmlspecialchars($specialty['hinh_anh']); ?>" alt="<?php echo htmlspecialchars($specialty['ten_chuyenkhoa']); ?>">
                                                <?php else: ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addSpecialtyForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="hinhAnh" class="form-label">Hình ảnh chuyên khoa</label>
                            <input type="file" class="form-control" id="hinhAnh" name="hinhAnh" accept="image/*">
                            <small class="form-text text-muted">Chọn hình ảnh đại diện cho chuyên khoa (JPG, PNG, GIF)</small>
                        </div>
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editSpecialtyModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editSpecialtyForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="edit_hinhAnh" class="form-label">Hình ảnh chuyên khoa</label>
                            ...
                            <div class="mt-2" id="current_image_container" style="display:none">
                                ...
                                <img id="current_image" src="" alt="Current Image" style="max-height: 100px; max-width: 100%;">
                            </div>
                            <small class="form-text text-muted">Chọn hình ảnh mới nếu muốn thay đổi (JPG, PNG, GIF)</small>
                        </div>
                        <div class="mb-3">
            ...
            $('#submitAddSpecialty').on('click', function() {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Try to parse the response in case it contains JSON with an error message
                        try {
                ...
                $.ajax({
                    ...
                    success: function(specialty) {
                        if (specialty) {
                            ...
                            if (specialty.hinh_anh) {
                                $('#current_image').attr('src', '../' + specialty.hinh_anh);
