...
<body>
    <div class="header">
        <div class="clinic-name">PHÒNG KHÁM ĐA KHOA T&A</div>
        <div class="clinic-info">Địa chỉ: 123 Nguyễn Văn Linh, Quận 7, TP.HCM</div>
        <div class="clinic-info">Điện thoại: 0987 654 321 | Email: info@phongkhamT&A.vn</div>
    </div>
    ...
    <div class="footer">
        ...
        <br>
        Cảm ơn quý khách đã tin tưởng và sử dụng dịch vụ của Phòng khám đa khoa T&A
    </div>
