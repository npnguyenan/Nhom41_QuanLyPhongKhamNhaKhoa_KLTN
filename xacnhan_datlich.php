...
if (isset($_GET['id'])) {
    ...
    $stmt = $conn->prepare(
        "SELECT l.*, bn.ho_ten AS bn_hoten, bn.dien_thoai AS bn_phone, b.ho_ten AS bs_hoten, b.hinh_anh AS bs_hinhanh, ds.ten_dichvu, ds.gia_coban 
         FROM lichhen l 
            ...
            <div class="col-lg-8">
                <div class="confirm-card">
                    <div class="confirm-header">
                        ...
                        <p>Cảm ơn bạn đã đặt lịch khám tại Nha Khoa T&A</p>
                    </div>
                        ...
                        <div class="appointment-summary">
                            ...
                            <div class="doctor-info">
                                <div class="doctor-avatar">
                                    <?php if (!empty($booking['bs_hinhanh'])): ?>
                                        <img src="<?= $booking['bs_hinhanh'] ?>" alt="<?= $booking['bs_hoten'] ?>">
                                    <?php else: ?>
                                        <img src="assets/img/doctor-default.jpg" alt="<?= $booking['bs_hoten'] ?>">
                                    <?php endif; ?>
                                </div>
                                <div>
                            ...
                            <div class="summary-item">
                                ...
                                <div class="summary-value">Nha Khoa T&A</div>
                            </div>

                            <div class="summary-item">
                                <div class="summary-label"><i class="fas fa-map-marker-alt me-2"></i>Địa chỉ:</div>
                                <div class="summary-value">67 Minh Khai, T&A, Lạng Sơn</div>
                            </div>
