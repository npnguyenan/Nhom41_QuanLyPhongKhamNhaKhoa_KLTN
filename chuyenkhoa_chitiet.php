...
<head>
    ...
    <style>
        ...
        /* Consistent styling for doctor cards */
        .doctor-card {
            border-radius: 10px;
            overflow: hidden;
            box-shadow: 0 5px 15px rgba(0, 0, 0, 0.05);
        ...
        /* Consistent styling for service cards */
        .service-card {
            padding: 30px;
            border-radius: 10px;
                    ...
                    <div class="service-card">
                        <div class="service-image">
                            <?php if (!empty($service['hinh_anh'])): ?>
                                <img src="<?= $service['hinh_anh'] ?>" alt="<?= htmlspecialchars($service['ten_dichvu']) ?>">
                            <?php elseif (!empty($specialty['hinh_anh'])): ?>
                                <img src="<?= $specialty['hinh_anh'] ?>" alt="<?= htmlspecialchars($specialty['ten_chuyenkhoa']) ?>">
                            <?php else: ?>
                                <i class="fas fa-stethoscope" style="font-size: 40px; color: var(--primary-color);"></i>
                            <?php endif; ?>
                        </div>
                        <h3 class="service-title"><?= htmlspecialchars($service['ten_dichvu']) ?></h3>
                        <p><?= !empty($service['mota_ngan']) ? htmlspecialchars($service['mota_ngan']) : 'Dịch vụ chăm sóc sức khỏe chuyên nghiệp.' ?></p>
                        <div class="service-price">
                            Giá: <?= formatPrice($service['gia_coban']) ?>
                        </div>
                        <div class="text-center mt-3">
                            <a href="datlich.php?service_id=<?= $service['id'] ?>" class="btn btn-primary">Đặt lịch</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
