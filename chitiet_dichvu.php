...
// Tạo thông tin bảng giá cho dịch vụ
$price_details = [
    'gia' => $service['gia_coban'],
    'ten_goi' => $service['ten_dichvu'],
    'mo_ta' => !empty($service['mota_ngan']) ? $service['mota_ngan'] : 'Dịch vụ chuyên nghiệp với đội ngũ y bác sĩ giàu kinh nghiệm',
    'chi_tiet' => !empty($service['chi_tiet']) ? $service['chi_tiet'] : "Khám tổng quát\nTư vấn kết quả\nTheo dõi điều trị\nDịch vụ chăm sóc chuyên nghiệp"
];
...
$banner_subtitle = !empty($service['mota_ngan']) 
    ? $service['mota_ngan'] 
    : 'Dịch vụ chăm sóc sức khỏe chuyên nghiệp tại ' . get_setting('site_name', 'Nha Khoa T&A');
?>
<!DOCTYPE html>
<html lang="vi">
<head>
                    ...
                    <div class="col-md-8 mx-auto mb-4">
                        <div class="package-card featured">
                            <div class="package-header">
                                <h3><?= $price_details['ten_goi'] ?></h3>
                                <div class="price"><?= formatPrice($price_details['gia']) ?></div>
                            </div>
                            <div class="package-body">
                                <p class="mb-3"><?= $price_details['mo_ta'] ?></p>
                                <ul>
                                    <?php 
                                    $features = explode("\n", $price_details['chi_tiet']);
                                ...
                                <a href="datlich.php?service_id=<?= $service_id ?>" class="btn btn-primary w-100">Đặt lịch khám</a>
                            </div>
                        </div>
                    </div>
                </div>
